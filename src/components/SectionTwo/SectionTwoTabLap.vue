<template>
    <section id="feature" class="px-2 mt-[104px] hidden md:block lg:mt-[150px] xl:mt-[250px] xl:px-4 2xl:px-0 2xl:mt-[450px]">
        ...
        <div class="flex flex-wrap mt-[48px] xl:justify-center xl:mt-[64px]">
            <div class="w-[480px] h-[210px] bg-[#F5F5F6] rounded-[32px] flex lg:w-[650px] lg:h-[312px] lg:items-center xl:w-[704px] xl:h-[350px] 2xl:w-[880px]">
                ...
                <img src="../../assets/image/phones/12.svg" alt="phone" class="w-[160px] pt-[30px] lg:w-[280px] lg:h-[312px] lg:pt-[38px] lg:pr-[40px] xl:h-[350px] 2xl:w-[300px] 2xl:pr-0">
            </div>
