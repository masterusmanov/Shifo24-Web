<template>
    <div class=" container mx-auto relative">
        <div class="slides-container h-72 flex snap-x snap-mandatory overflow-hidden overflow-x-auto space-x-2 rounded scroll-smooth before:w-[45vw] before:shrink-0 after:w-[45vw] after:shrink-0 md:before:w-0 md:after:w-0" ref="slidesContainer">
            <div class="w-[300px] h-[285px] mx-auto rounded-[16px] border md:w-[360px] lg:w-[335px] xl:w-[410px] 2xl:w-[505px] xl:h-[242px] 2xl:h-[232px] slide aspect-square  flex-shrink-0 snap-center overflow-hidden">
                <div class="">
                    <div class=" mt-[24px]">
       ...
       <div class="flex justify-beetwen items-center gap-4 md:gap-0 mt-[32px] md:mt-[56px] xl:mt-[48px]">
        <h2 class="md:w-[87%] lg:w-[90%] xl:w-[92%] 2xl:w-[94%] font-rubik text-[16px] font-[400] text-[#424259]">Xizmatlarimiz <span class="text-[#2588AF]">100+</span> odamlarni xursand qilgan</h2>
