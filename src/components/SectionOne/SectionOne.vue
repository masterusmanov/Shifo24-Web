    ...
    <section class="mt-[32px] px-2 md:hidden">
        ...
        <div class="flex justify-center gap-4 mt-[56px]">
            <div class="px-2 w-[48%]">
                ...
                <p class="text-[12px] text-[#424259] leading-[15.708px] mt-[22px] font-rubik">Biz shifokorlarimiz bilan bemorlarimizga tibbiy xizmatlar ko'rsatishda tajribaga egamiz</p>
            </div>
            <div class="px-2 w-[48%]">
